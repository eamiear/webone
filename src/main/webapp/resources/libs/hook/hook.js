            ...
            return this.each(function () {
                ...
                if (typeof (settings) === 'undefined') {
                    ...
                    var defaults = {
                        ...
                        swipeDistance: 10, // swipe distance for loader to show on touch devices
                ...
                if (!hasTouch()) {
                    ...
                    addHandler('touchmove', function (e) {
                        swipeX = e.originalEvent.touches[0].pageX - lastX;
						swipeY = e.originalEvent.touches[0].pageY - lastY;
                        st = $(this).scrollTop();
						//alert(st+","+swipe);
                        if (st <= 0 && swipeY > settings.swipeDistance && swipeX<20 && swipeX>-20) {
                            methods.onSwipe($this, settings);
							//alert(settings.swipeDistance+","+swipeX+","+swipeY);
                        }
                    });
